...
public abstract class Config {
    ...
    public static final String ACCESS_TOKEN = "6f38cc66ba91450b99cc8921d9a61c8b";

    public static final LanguageConfig[] languages = new LanguageConfig[]{
            new LanguageConfig("en", "6f38cc66ba91450b99cc8921d9a61c8b"),
    ...
    // REST ENDPOINTS
    public static final String REST_URL = "http://websvr.cc.com:8080/ECC-1.0-SNAPSHOT/rest/members/json/diag/get";
    public static final String REST_URL_TOKEN = "http://websvr.cc.com:8080/ECC-1.0-SNAPSHOT/rest/members/token";
    public static final String REST_CONSUMER_KEY = "";
    public static final String REST_CONSUMER_SECRET = "";
    // REST ENDPOINTS FOR ECE Messaging server
    public static final String CHAT_REST_URL = "https://capricorn.ucplanning.com:5000/cumulus-html5-mobile";

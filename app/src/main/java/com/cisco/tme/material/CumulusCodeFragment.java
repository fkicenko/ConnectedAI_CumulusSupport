package com.cisco.tme.material;
...
import com.cisco.tme.dialog.DialogUtils;
import com.cisco.tme.theme.MaterialTheme;
import com.cisco.tme.log.LogUtils;
 ...
 * @author Steven Byle
 */
public class CumulusCodeFragment extends Fragment implements OnClickListener {

    public static CumulusCodeFragment newInstance() {
        Timber.v(LogUtils.METHOD_ONLY);

        // Create a new fragment instance
        CumulusCodeFragment fragment = new CumulusCodeFragment();
